...
target = 9
print(
    f"Test case 1: {Solution.recursive_search(nums, target, 0, len(nums) - 1)}"
)  # Expected Output: 4
...
target = 2
print(
    f"Test case 2: {Solution.recursive_search(nums, target, 0, len(nums) - 1)}"
)  # Expected Output: -1
...
target = 1
print(
    f"Test case 3: {Solution.recursive_search(nums, target, 0, len(nums) - 1)}"
)  # Expected Output: -1
...
target = 5
print(
    f"Test case 4: {Solution.recursive_search(nums, target, 0, len(nums) - 1)}"
)  # Expected Output: 0
...
target = 3
print(
    f"Test case 5: {Solution.recursive_search(nums, target, 0, len(nums) - 1)}"
)  # Expected Output: -1
