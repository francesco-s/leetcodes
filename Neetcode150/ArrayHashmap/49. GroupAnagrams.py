...
print(
    f"Test case 1: {solution.groupAnagrams(strs1)}"
...
print(
    f"Test case 4: {solution.groupAnagrams(strs4)}"
)  # Expected: [["abc","bca","cab"],["xyz"]]

# Test case 5
strs5 = ["abbbbbbbbbbb", "aabbbbbbbbbb"]
print(
    f"Test case 5: {solution.groupAnagrams(strs5)}"
)  # Expected: [["abbbbbbbbbbb"],["aabbbbbbbbbb"]]
